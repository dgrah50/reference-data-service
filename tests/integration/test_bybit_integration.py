...
@pytest.mark.asyncio
async def test_bybit_fetch_spot_snapshot(integration_timeout):
    """Test fetching real spot data from Bybit testnet."""
...
@pytest.mark.integration
@pytest.mark.asyncio
async def test_bybit_fetch_perpetual_snapshot(integration_timeout):
    """Test fetching real perpetual data from Bybit testnet."""
    adapter = BybitExchangeAdapter(is_testnet=True)
    try:
        # Get the endpoint configuration
...
@pytest.mark.integration
@pytest.mark.asyncio
async def test_bybit_fetch_futures_snapshot(integration_timeout):
    """Test fetching real futures data from Bybit testnet."""
    adapter = BybitExchangeAdapter(is_testnet=True)
    try:
        # Get the endpoint configuration
...
@pytest.mark.integration
@pytest.mark.asyncio
async def test_bybit_adapter_initialization(integration_timeout):
    """Test that Bybit adapter initializes correctly in testnet mode."""
    adapter = BybitExchangeAdapter(is_testnet=True)
    try:
